  ...
  return (
    <div>
      <Head className={darkMode ? "dark" : ""}>
        <title>Anastasiia Kolesnyk Portfolio</title>
     ...
     <main className=" bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
      <section className="min-h-screen">
        <nav className="py-10 mb-12 flex justify-between">
          <h1 className="text-xl font-burtons">developedbyNastya</h1>
        ...
        <div className=" text-center p-10">
          <h2 className="text-5xl py-2 text-teal-600 font-medium md:text-6xl">Anastasiia Kolesnyk</h2>
      ...
      <section>
        <div>
          ...
          <p className="text-md py-2 leading-8 text-gray-800">Since the beginning of my journey as a freelance developer, I have done remote work for bla-bla-bla
          <span className="text-teal-500"> agencies </span> consulted for <span className="text-teal-500">startups </span> and collobarated with talanted people to created dogotal products for bosth business and consumer use.
          </p>
          <p className="text-md py-2 leading-8 text-gray-800">I offer froma wide range of services, including prgramming and teaching.
          </p>
        </div>
        <div className="lg:flex gap-10">
          <div className="text-center shadow-lg p-10 rounded-xl my-10">
            ...
            <p className="py-2">
              Creating elegant designs suited for your needs corelated by design theory.
            </p>
      ...
      <section>
        <div>
          <h3 className=" text-3xl py-1">Potfolio</h3>
          <p className="text-md py-2 leading-8 text-gray-800">Since the beginning of my journey as a freelance developer, I have done remote work for bla-bla-bla
          <span className="text-teal-500"> agencies </span> consulted for <span className="text-teal-500">startups </span> and collobarated with talanted people to created dogotal products for bosth business and consumer use.
          </p>
          <p className="text-md py-2 leading-8 text-gray-800">I offer froma wide range of services, including prgramming and teaching.
